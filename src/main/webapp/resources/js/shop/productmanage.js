$(function () {
    ...
    //商品下架
    //var deleteUrl = '/o2o/shopadmin/removeproduct';
    getList();
    //从后台获取次店铺的商品列表
    ...
    $('.product-wrap').on('click', 'a', function(e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    //如果有class edit则进入店铺信息编辑页面，并带有productId参数
   ...
   $('#new').click(function () {
    ...
    /*$('#new').click(function() {
        ...
        tempArr.map(function(index, item) {
            var tempObj = {};
            tempObj.productName = $(item).find('.category').val();
            tempObj.priority = $(item).find('.priority').val();
            if (tempObj.productName && tempObj.priority) {
